...
public class LeaveApprovalController {
    ...
    @GetMapping("/pending")
    public List<PendingLeaveRequestDto.PendingLeaveRequestResponse> getPendingRequests(@AuthenticationPrincipal LoginPrincipal principal) {
    ...
    @GetMapping("/approved")
    public List<LeaveRequestListDto.LeaveRequestListResponse> getApprovedRequests(@RequestParam(value = "team", required = false) String team, @AuthenticationPrincipal LoginPrincipal principal) {
    ...
    @GetMapping("/rejected")
    public List<LeaveRequestListDto.LeaveRequestListResponse> getRejectedRequests(@RequestParam(value = "team", required = false) String team, @AuthenticationPrincipal LoginPrincipal principal) {
    ...
    public LeaveApprovalDto.LeaveApprovalResponse approveLeaveRequest(@PathVariable("requestId") Long requestId, @AuthenticationPrincipal LoginPrincipal principal) {
    ...
    public LeaveRejectDto.LeaveRejectResponse rejectLeaveRequest(@PathVariable("requestId") Long requestId, @AuthenticationPrincipal LoginPrincipal principal, @Valid @RequestBody LeaveRejectDto.LeaveRejectRequest request) {
