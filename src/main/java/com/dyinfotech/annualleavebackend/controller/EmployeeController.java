...
public class EmployeeController {
    ...
    @GetMapping("/me")
    public EmployeeDto.EmployeeResponse getMyInfo(@AuthenticationPrincipal LoginPrincipal principal) {
    ...
    public ResponseEntity<Void> changeEmail(@AuthenticationPrincipal LoginPrincipal principal, @Valid @RequestBody EmployeeDto.ModifyEmailRequest email) {
    ...
    public ResponseEntity<Void> changePassword(@AuthenticationPrincipal LoginPrincipal principal, @Valid @RequestBody EmployeeDto.PasswordChangeRequest request) {
